...
// TL;DR: basic types are passed by value - complex types are reference types.
// Complex types zero value is nil.
...
// this modifies the original variable. maps are reference types
...
// Complex types zero value is nil.
func doComplexTypes() {
	a := map[string]int{} // short variable declaration
